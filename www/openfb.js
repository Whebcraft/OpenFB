module.exports = {
  fb: function () {
    ...
    function img(obj) {
        ...
        url = 'https://graph.facebook.com/v2.7' + obj.path + '?' + toQueryString(params) +'&fields=id,birthday,email,first_name,gender,last_name,link,locale,name,timezone,updated_time,verified,website&format=json';
